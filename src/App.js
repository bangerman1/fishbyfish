            ...
            <div className="buyContent">
              ...
              <div className="textBlock">
                ...
                <div className="socialsBlock">
                  <a href="https://t.me/aDolfin_channel" _blank><img className="socialImg" alt="telegram" src={tg}/></a>
                  <a href="https://twitter.com/aDolfin_1488" _blank><img className="socialImg" alt="twitter" src={twitter}/></a>
                </div>
              </div>
            </div>
          </div>
